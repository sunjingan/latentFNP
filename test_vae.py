...
def subprocess_fn(args):
    ...
    encoder_path = f'{args.rundir}/best_encoder.pth'
    decoder_path = f'{args.rundir}/best_decoder.pth'
    model.kernel.g_a.load_state_dict(torch.load(encoder_path))
    model.kernel.g_s.load_state_dict(torch.load(decoder_path))
